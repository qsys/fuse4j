...
typedef struct _jclass_fuse_FuseFSFactory
{
   ...
   struct
   {
      jmethodID adapt__Lfuse_Filesystem3_Ljava_util_logging_Logger_;
      jmethodID adapt__Lfuse_compat_Filesystem1_Ljava_util_logging_Logger_;
      jmethodID adapt__Lfuse_compat_Filesystem2_Ljava_util_logging_Logger_;
      jmethodID adapt__Ljava_lang_Object_;
      jmethodID adapt__Ljava_lang_Object_Ljava_util_logging_Logger_;
