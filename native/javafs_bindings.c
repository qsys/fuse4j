...
jclass_fuse_FuseFSFactory *alloc_jclass_fuse_FuseFSFactory(JNIEnv *env)
{
   ...
   while (1)
   {
      ...
      // obtain static method IDs
      fuse_FuseFSFactory->static_method.adapt__Lfuse_Filesystem3_Ljava_util_logging_Logger_ = (*env)->GetStaticMethodID(env, fuse_FuseFSFactory->class, "adapt", "(Lfuse/Filesystem3;Ljava/util/logging/Logger;)Lfuse/FuseFS;");
      if ((*env)->ExceptionCheck(env)) break;
      fuse_FuseFSFactory->static_method.adapt__Lfuse_compat_Filesystem1_Ljava_util_logging_Logger_ = (*env)->GetStaticMethodID(env, fuse_FuseFSFactory->class, "adapt", "(Lfuse/compat/Filesystem1;Ljava/util/logging/Logger;)Lfuse/FuseFS;");
      if ((*env)->ExceptionCheck(env)) break;
      fuse_FuseFSFactory->static_method.adapt__Lfuse_compat_Filesystem2_Ljava_util_logging_Logger_ = (*env)->GetStaticMethodID(env, fuse_FuseFSFactory->class, "adapt", "(Lfuse/compat/Filesystem2;Ljava/util/logging/Logger;)Lfuse/FuseFS;");
      if ((*env)->ExceptionCheck(env)) break;
      ...
      if ((*env)->ExceptionCheck(env)) break;
      fuse_FuseFSFactory->static_method.adapt__Ljava_lang_Object_Ljava_util_logging_Logger_ = (*env)->GetStaticMethodID(env, fuse_FuseFSFactory->class, "adapt", "(Ljava/lang/Object;Ljava/util/logging/Logger;)Lfuse/FuseFS;");
      if ((*env)->ExceptionCheck(env)) break;
